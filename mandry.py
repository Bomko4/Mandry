...
async def process_phone(message: types.Message, state: FSMContext):
    ...
    await message.answer("Хочемо повідомити, що цих вихідних команда території організовує концерт.\nПроте для наших гостей працює ось така механіка і тоді заїзд стандартно - парковка 200 грн/авто.\nВам потрібно повідомити при вʼїзді, що у вас є бронювання на сапах і показати промокод. Надсилаємо вам промокод – mandrysupp200626\nПокажіть його на охороні та отримайте браслет з нашим логотипом. Браслет - це саме перепустка до нашого простору \n❗️Браслет не дає доступу до концерту")
